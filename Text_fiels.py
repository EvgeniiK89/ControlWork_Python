...
for_find_data = 'Введите дату для его нахождения(пример 15/07/23 09:34 PM ): '
for_find_name = 'Введите имя заметки для нахожднгия: '
close = 'Вы выщли из журнала заметок.'